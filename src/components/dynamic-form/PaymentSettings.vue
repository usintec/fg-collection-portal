...
<template>
  <div class="flex flex-col w-full">
    <div class="flex justify-between items-center my-3">
      <div>
        <span class="bg-[#F0F8FF] p-2 rounded-md px-4 text-sm text-[#4E9DE7] me-3"
          >Provider Name: <strong>Paystack</strong></span
        >

        <span class="text-[#204458] text-sm"
          ><strong>Base Url</strong>: https://api.paystack.co/v3</span
        >
      </div>
